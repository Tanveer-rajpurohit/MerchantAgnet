      ...
      <div className="rounded-xl border border-border bg-surface shadow-xs transition-all focus-within:border-brand/50 focus-within:bg-surface">
        {selectedCustomers.length > 0 && (
          <div className="flex flex-wrap items-center gap-2 px-4 pt-2.5">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-medium bg-brand/10 text-brand border border-brand/20 shadow-2xs">
            ...
            <div className="flex items-center gap-1.5 overflow-x-auto hide-scrollbar text-[11px]">
              <button
                ...
                className="px-2 py-0.5 rounded-md border border-border bg-surface-muted hover:bg-border/40 text-secondary hover:text-primary transition-colors cursor-pointer whitespace-nowrap"
              >
                Ready for pickup
              </button>
              <button
          ...
          <div className="flex items-center gap-1.5">
            <div className="relative" ref={customerDropdownRef}>
              <button
                ...
                className={`flex items-center gap-1.5 px-2.5 h-8 rounded-md text-xs font-medium font-intert transition-colors cursor-pointer ${
              ...
              {isCustomerDropdownOpen && (
                <div className="absolute bottom-full left-0 mb-2 w-72 max-h-72 overflow-y-auto rounded-xl border border-border bg-surface shadow-xl z-50 p-2 font-intert animate-in fade-in zoom-in-95 duration-100">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <div className="pt-2 mt-1 border-t border-border/50 flex items-center justify-between px-2 text-[11px]">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 rounded-md bg-brand text-white text-[11px] font-medium hover:bg-brand/90 transition-colors cursor-pointer"
                        >
                          Done
                        </button>
                      </div>
          ...
          <div className="flex items-center gap-2">
            {isSpeechSupported && (
              <button
                ...
                title={isListening ? "Stop listening" : "Speak to write in real time"}
